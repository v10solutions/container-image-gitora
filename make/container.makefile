...
container-run-linux:
	...
	| $(BIN_DOCKER) container cp "-" "gitora":"/opt/tomcat"
...
.PHONY: container-rm
container-rm:
	$(BIN_DOCKER) container rm -f "gitora"
